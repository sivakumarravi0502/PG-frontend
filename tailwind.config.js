  ...
  theme: {
    extend: {
      colors: {
        ...
        sidenav: {
          bg: 'hsl(var(--sidenav-bg))',
          border: 'hsl(var(--sidenav-border))',
          item: 'hsl(var(--sidenav-item))',
      ...
      fontFamily: {
        ...
        heading: ['"Google Sans"', 'Nunito', 'ui-sans-serif', 'system-ui', 'sans-serif'],
      },
      borderRadius: { lg: 'var(--radius)', md: 'calc(var(--radius) - 2px)', sm: 'calc(var(--radius) - 4px)' },
      boxShadow: { card: '0 1px 4px 0 rgba(130,143,163,0.15)' },
    },
  },
  plugins: [],
};
